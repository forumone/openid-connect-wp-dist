...
- Readme fix: @thijskh - Fix syntax error in example openid-connect-wp-login-button-text
...
- Feature: @wgengarelly - Added `openid-connect-wp-update-user-using-current-claim` action hook allowing other plugins/themes
